        ...
        >
          ...
          <form className="text-white w-full" onSubmit={handleSubmit}>
            ...
            <div className="mb-6 flex justify-center">
              <button
                type="submit"
                className=" text-white bg-mid-green hover:bg-dark-green focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-lg sm:w-auto px-5 py-2.5 text-center font-Montserrat capitalize " onClick={displayReviewForm}
              >
                SUBMIT
              </button>
            </div>
